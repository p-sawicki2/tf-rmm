...
#define RDFREMONT_RMM_UART	MAP_REGION_FLAT(			\
					RMM_UART_ADDR,			\
					SZ_4K,				\
...
void plat_setup(uint64_t x0, uint64_t x1, uint64_t x2, uint64_t x3)
{
	...
	uart_init(RMM_UART_ADDR, RDFREMONT_UART_CLK_IN_HZ,
			RDFREMONT_UART_BAUDRATE);
