...
static int attest_get_platform_token(uint64_t buf_pa, uint64_t buf_size,
				     uint64_t c_size, uint64_t *token_size,
				     uint64_t *remaining_len)
{
	 ...
	 */
	if (platform_token_offset + buf_size >= platform_token_size) {
		buf_size = platform_token_size - platform_token_offset;
	}
	...
	*token_size = platform_token_size;
	platform_token_offset += buf_size;
