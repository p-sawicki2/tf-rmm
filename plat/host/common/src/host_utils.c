...
void host_util_setup_sysreg_and_boot_manifest(void)
{
	 ...
	 */
	host_util_set_default_sysreg_cb("id_aa64dfr0_el1",
	 ...
	 */
	host_util_set_default_sysreg_cb("id_aa64mmfr0_el1",
	 ...
	 */
	host_util_set_default_sysreg_cb("ich_vtr_el2",
			INPLACE(ICH_VTR_EL2_PRE_BITS, 5UL));

	/* SCTLR_EL2 is reset to zero */
	host_util_set_default_sysreg_cb("sctlr_el2", 0UL);

	/* HCR_EL2 is reset to zero */
	host_util_set_default_sysreg_cb("hcr_el2", 0UL);

	/* TPIDR_EL2 is reset to zero */
	host_util_set_default_sysreg_cb("tpidr_el2", 0UL);

	/* ID_AA64ISAR0.RNDR is reset to 1 */
	host_util_set_default_sysreg_cb("id_aa64isar0_el1",
