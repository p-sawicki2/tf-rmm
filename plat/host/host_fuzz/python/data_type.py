...
SIZE_OF_GRANULE=os.getenv("GRANULE_META_SIZE", 4)

# fuzzing command config
COMMAND_COUNT=os.getenv("FUZZING_COMMAND_COUNT", 10)
REGISTER_COUNT=os.getenv("FUZZING_REGISTER_COUNT", 7)
REGISTER_SIZE=os.getenv("REGISTER_SIZE", 8)

# The opcode range for fuzzing
FID_BEGIN=os.getenv("FUZZING_FID_BEGIN", 0xC4000150)
FID_END=os.getenv("FUZZING_FID_END", 0xC4000190)
