...
/*
 * The fake_host_architecture does not do any address translation. Provide a dummy
 * address for the shared PA. We do not use the real shared buf address here as it
 * may collide with the dummy values in mmap regions and cause xlat_table_init to fail.
 */
