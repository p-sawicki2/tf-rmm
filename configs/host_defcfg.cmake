...
arm_config_option(
    ...
    TYPE BOOL
    DEFAULT "ON"
    DEPENDS (RMM_HOST_VARIANT STREQUAL host_test)
    ADVANCED)
...
#
# Build on Debug mode by default so assertions can be enabled.
#
arm_config_option_override(NAME CMAKE_BUILD_TYPE DEFAULT "Debug")
