...
.. code-block:: bash
    ...
    cmake -DRMM_CONFIG=host_defcfg -DRMM_HOST_VARIANT=build_test HTML_COVERAGE_REPORT=ON -S ${RMM_SOURCE_DIR} -B ${RMM_BUILD_DIR}
    cmake --build ${RMM_BUILD_DIR}
    make test -C ${RMM_BUILD_DIR}
...
.. code-block:: bash
    ...
    cmake -DRMM_CONFIG=host_defcfg -DRMM_HOST_VARIANT=build_test COVERAGE_ENABLED=OFF -S ${RMM_SOURCE_DIR} -B ${RMM_BUILD_DIR}
    cmake --build ${RMM_BUILD_DIR}
