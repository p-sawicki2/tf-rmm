...
.. code-block:: bash
    ...
    cmake --build ${RMM_BUILD_DIR} -- create-coverage
...
16. Perform coverage analysis without unit tests
...
.. csv-table:: RMM CMake Options Table
   ...
   RMM_COVERAGE         , ON | OFF, OFF, "Enable coverage analysis when unit tests are enabled"
