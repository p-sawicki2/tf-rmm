...
.. table:: Table 2: RMM Assets
  ...
  |                    |   cannot be hijacked by an atacker.               |
  ...
  |                    | | should be designed in such a way that neither   |
  |                    |   Realm nor RMM should significantly affect the   |
  |                    | | availability of NS Host and Secure World.       |
  +--------------------+---------------------------------------------------+
...
There is also a number of Threats which are not covered by this Threat Model.
These are listed in the table below.

.. table:: Table 4: Threat Agents no covered by this Threat Model
