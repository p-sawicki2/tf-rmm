...
| ID                     | 06                                                |
+========================+===================================================+
| Threat                 | | Data corruption or dead/live locks due to       |
|                        |   incorrect implementation of concurrent sections.|
+------------------------+---------------------------------------------------+
| Diagram Elements       | DF5, DF7                                          |
+------------------------+---------------------------------------------------+
| Assets                 | Availability, Sensitive Data, Code Execution      |
...
|                        | | other Realms or to wrongly map incorrect memory |
|                        |   (such as NS or Secure areas) to Realms, leading |
|                        | | to memory model issues.                         |
|                        | | It is also possible that RMM does not perform   |
|                        |   all the right Stage2/TLB invalidations in which |
|                        | | a NS VM can cause issues for another NS VM via  |
|                        |   Realm world, providing that both NS VMs have    |
|                        | | distinct counterparts in the Realm space.       |
+------------------------+---------------------------------------------------+
| Diagram Elements       | DF5, DF7                                          |
+------------------------+---------------------------------------------------+
| Assets                 | Sensitive Data, Code execution                    |
