...
|                        |   using RMM ABI.                                  |
|                        |                                                   |
|                        | | NS Host access RMM through RMM ABI. Malicious   |
...
|                        |      each others CPU register contents other than |
|                        | |    what is allowed by RMM ABI. Root code should |
...
|                        |      map metadata only when needed and it unmapped|
|                        | |    when the access is not required.             |
+------------------------+---------------------------------------------------+
| Pending actions?       | None                                              |
+------------------------+---------------------------------------------------+
