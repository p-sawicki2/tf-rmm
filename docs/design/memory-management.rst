...
Memory accessed by the |RMM| and can be categorised as follows:
...
categories except for the REC data structure. In this case, access
to this data structure is protected by holding a reference count
during execution of *RmiRecEnter*.
