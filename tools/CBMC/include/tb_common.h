 ...
 * Ref: CBMC automatically returns nondet values, or symbolic values, matching the return types.
 * However, in my experience, enum is treated as integer hence the value might out of range.
 */
...
typedef uint64_t rmi_data_flags_t;
