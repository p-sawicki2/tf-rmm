    ...
    uint64_t params_ptr)
{
    ...
    if (prop_success_rec_index_ante) {
        bool prop_success_rec_index_cons = success_rec_index_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_gran_state_ante) {
        bool prop_success_rec_gran_state_cons = success_rec_gran_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_owner_ante) {
        bool prop_success_rec_owner_cons = success_rec_owner_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_attest_ante) {
        bool prop_success_rec_attest_cons = success_rec_attest_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_mpidr_ante) {
        bool prop_success_rec_mpidr_cons = success_rec_mpidr_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_state_ante) {
        bool prop_success_rec_state_cons = success_rec_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_runnable_ante) {
        bool prop_success_runnable_cons = success_runnable_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_not_runnable_ante) {
        bool prop_success_not_runnable_cons = success_not_runnable_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_gprs_ante) {
        bool prop_success_rec_gprs_cons = success_rec_gprs_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_pc_ante) {
        bool prop_success_rec_pc_cons = success_rec_pc_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_aux_ante) {
        bool prop_success_rec_aux_cons = success_rec_aux_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rec_aux_state_ante) {
        bool prop_success_rec_aux_state_cons = success_rec_aux_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_ripas_addr_ante) {
        bool prop_success_ripas_addr_cons = success_ripas_addr_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_ripas_top_ante) {
        bool prop_success_ripas_top_cons = success_ripas_top_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_host_call_ante) {
        bool prop_success_host_call_cons = success_host_call_post && (result == RMI_SUCCESS);
