...
void entry_point(
    void)
{
    tb_rsi_measurement_extend(nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t());
}
