...
#include "tb.h"
#include "tb_rmi_data_create_unknown.h"
    ...
    uint64_t ipa)
{
    ...
    __tb_regs.X0 = SMC_RMM_DATA_CREATE_UNKNOWN;
    ...
    bool no_failures_pre = !failure_data_align_pre
    ...
    bool success_data_content_pre = __tb_arb_bool();
    ...
    bool success_data_content_post = success_data_content_pre;
    ...
    bool prop_failure_data_align_ante = failure_data_align_pre;
    ...
    bool prop_failure_data_bound_ante = !failure_data_align_pre
        && failure_data_bound_pre;
    ...
    bool prop_failure_data_state_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && failure_data_state_pre;
    ...
    bool prop_failure_rd_align_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && failure_rd_align_pre;
    ...
    bool prop_failure_rd_bound_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && failure_rd_bound_pre;
    ...
    bool prop_failure_rd_state_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && !failure_rd_bound_pre
    ...
    bool prop_failure_ipa_align_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && !failure_rd_bound_pre
    ...
    bool prop_failure_ipa_bound_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && !failure_rd_bound_pre
    ...
    bool prop_failure_rtt_walk_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && !failure_rd_bound_pre
    ...
    bool prop_failure_rtte_state_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && !failure_rd_bound_pre
    ...
    bool prop_success_data_content_ante = no_failures_pre;
    __COVER(prop_success_data_content_ante);
    if (prop_success_data_content_ante) {
        bool prop_success_data_content_cons = success_data_content_post && (result == RMI_SUCCESS);
        __COVER(prop_success_data_content_cons);
        __ASSERT(prop_success_data_content_cons, "prop_success_data_content_cons");
    }
