    ...
    uint64_t ipa)
{
    ...
    bool prop_failure_rtte_ripas_ante = !failure_data_align_pre
        && !failure_data_bound_pre
        && !failure_data_state_pre
        && !failure_rd_align_pre
        && !failure_rd_bound_pre
    ...
    if (prop_success_data_content_ante) {
        bool prop_success_data_content_cons = success_data_content_post;
...
void entry_point(
    void)
{
    tb_rmi_data_create_unknown(nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t());
}
