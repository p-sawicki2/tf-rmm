    ...
    uint64_t target_rec)
{
    ...
    if (prop_success_pending_ante) {
        bool prop_success_pending_cons = success_pending_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_on_already_ante) {
        bool prop_success_on_already_cons = success_on_already_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_on_success_ante) {
        bool prop_success_on_success_cons = success_on_success_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_affinity_on_ante) {
        bool prop_success_affinity_on_cons = success_affinity_on_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_affinity_off_ante) {
        bool prop_success_affinity_off_cons = success_affinity_off_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_gprs_ante) {
        bool prop_success_gprs_cons = success_gprs_post && (result == RMI_SUCCESS);
