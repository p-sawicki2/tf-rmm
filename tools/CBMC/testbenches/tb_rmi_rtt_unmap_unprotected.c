...
#include "tb.h"
#include "tb_rmi_rtt_unmap_unprotected.h"
    ...
    int64_t level)
{
    ...
    __tb_regs.X0 = SMC_RMM_RTT_UNMAP_UNPROTECTED;
    ...
    bool failure_rtte_state_pre = walk.entry.state != ASSIGNED_NS;
    ...
    bool success_rtte_state_post = walk.entry.state == UNASSIGNED_NS;
