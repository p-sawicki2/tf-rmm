    ...
    int64_t level)
{
    ...
    bool success_rtte_c_addr_pre = (unfold.state != UNASSIGNED && unfold.state != UNASSIGNED_NS && unfold.state != DESTROYED);
    ...
    if (prop_success_rtte_c_ripas_ante) {
        bool prop_success_rtte_c_ripas_cons = success_rtte_c_ripas_post;
    ...
    if (prop_success_rtte_c_state_ante) {
        bool prop_success_rtte_c_state_cons = success_rtte_c_state_post;
    ...
    if (prop_success_rtte_c_addr_ante) {
        bool prop_success_rtte_c_addr_cons = success_rtte_c_addr_post;
...
void entry_point(
    void)
{
    tb_rmi_rtt_create(nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_int64_t());
}
