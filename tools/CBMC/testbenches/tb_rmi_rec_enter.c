    ...
    uint64_t run_ptr)
{
    ...
    if (prop_success_rec_exit_ante) {
        bool prop_success_rec_exit_cons = success_rec_exit_post;
    ...
    if (prop_success_rec_emul_abt_ante) {
        bool prop_success_rec_emul_abt_cons = success_rec_emul_abt_post;
...
void entry_point(
    void)
{
    tb_rmi_rec_enter(nondet_uint64_t(), nondet_uint64_t());
}
