    ...
    uint64_t params_ptr)
{
    ...
    if (prop_success_rd_state_ante) {
        bool prop_success_rd_state_cons = success_rd_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_realm_state_ante) {
        bool prop_success_realm_state_cons = success_realm_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rtt_base_ante) {
        bool prop_success_rtt_base_cons = success_rtt_base_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rtte_p_states_ante) {
        bool prop_success_rtte_p_states_cons = success_rtte_p_states_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rtte_up_states_ante) {
        bool prop_success_rtte_up_states_cons = success_rtte_up_states_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_ipa_width_ante) {
        bool prop_success_ipa_width_cons = success_ipa_width_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_hash_algo_ante) {
        bool prop_success_hash_algo_cons = success_hash_algo_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rem_ante) {
        bool prop_success_rem_cons = success_rem_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rtt_level_ante) {
        bool prop_success_rtt_level_cons = success_rtt_level_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rtt_num_ante) {
        bool prop_success_rtt_num_cons = success_rtt_num_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_vmid_ante) {
        bool prop_success_vmid_cons = success_vmid_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_rpv_ante) {
        bool prop_success_rpv_cons = success_rpv_post && (result == RMI_SUCCESS);
