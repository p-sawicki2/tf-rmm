    ...
    uint64_t addr)
{
    ...
    bool success_gran_content_pre = __tb_arb_bool();
    ...
    bool success_gran_pas_post = Granule(addr).pas == NS;
    bool success_gran_state_post = Granule(addr).state == UNDELEGATED;
    bool success_gran_content_post = success_gran_content_pre;
    ...
    if (prop_success_gran_content_ante) {
        bool prop_success_gran_content_cons = success_gran_content_post && (result == RMI_SUCCESS);
