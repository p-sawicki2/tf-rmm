...
void entry_point(
    void)
{
    tb_rsi_attestation_token_init(nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t(), nondet_uint64_t());
}
