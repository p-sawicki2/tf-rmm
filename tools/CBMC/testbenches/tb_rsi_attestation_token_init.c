    ...
    uint64_t challenge_7)
{
    ...
    if (prop_success_state_ante) {
        bool prop_success_state_cons = success_state_post && (result == RSI_SUCCESS);
    ...
    if (prop_success_addr_ante) {
        bool prop_success_addr_cons = success_addr_post && (result == RSI_SUCCESS);
    ...
    if (prop_success_challenge_ante) {
        bool prop_success_challenge_cons = success_challenge_post && (result == RSI_SUCCESS);
