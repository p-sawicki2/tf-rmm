    ...
    int64_t level)
{
    ...
    if (prop_success_state_ante) {
        bool prop_success_state_cons = success_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_state_invalid_ante) {
        bool prop_success_state_invalid_cons = success_state_invalid_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_state_prot_ante) {
        bool prop_success_state_prot_cons = success_state_prot_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_state_unprot_ante) {
        bool prop_success_state_unprot_cons = success_state_unprot_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_ripas_unprot_ante) {
        bool prop_success_ripas_unprot_cons = success_ripas_unprot_post && (result == RMI_SUCCESS);
