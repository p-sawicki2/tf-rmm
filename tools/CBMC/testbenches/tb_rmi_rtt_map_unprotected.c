    ...
    uint64_t desc)
{
    ...
    bool failure_rtte_state_pre = (walk.entry.state != UNASSIGNED_NS && walk.entry.state != DESTROYED);
...
void entry_point(
    void)
{
    tb_rmi_rtt_map_unprotected(nondet_uint64_t(), nondet_uint64_t(), nondet_int64_t(), nondet_uint64_t());
}
