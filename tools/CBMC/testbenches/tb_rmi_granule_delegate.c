    ...
    uint64_t addr)
{
    ...
    if (prop_success_gran_state_ante) {
        bool prop_success_gran_state_cons = success_gran_state_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_gran_pas_ante) {
        bool prop_success_gran_pas_cons = success_gran_pas_post && (result == RMI_SUCCESS);
