    ...
    uint64_t ipa)
{
    ...
    bool success_ripas_empty_pre = walk.entry.ripas == EMPTY;
    ...
    bool success_ripas_empty_post = walk.entry.state == UNASSIGNED;
    bool success_ripas_ram_post = walk.entry.state == DESTROYED;
    bool success_data_post = data == walk.entry.addr;
    bool success_top_post = top == walk_top;
    bool success_data_post = true;
    bool success_top_post = true;
    ...
    bool prop_success_ripas_empty_ante = no_failures_pre
        && success_ripas_empty_pre;
    __COVER(prop_success_ripas_empty_ante);
    if (prop_success_ripas_empty_ante) {
        bool prop_success_ripas_empty_cons = success_ripas_empty_post;
        __COVER(prop_success_ripas_empty_cons);
        __ASSERT(prop_success_ripas_empty_cons, "prop_success_ripas_empty_cons");
    }
...
void entry_point(
    void)
{
    tb_rmi_data_destroy(nondet_uint64_t(), nondet_uint64_t());
}
