    ...
    uint64_t ipa)
{
    ...
    if (prop_success_ripas_ram_ante) {
        bool prop_success_ripas_ram_cons = success_ripas_ram_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_data_ante) {
        bool prop_success_data_cons = success_data_post && (result == RMI_SUCCESS);
    ...
    if (prop_success_top_ante) {
        bool prop_success_top_cons = success_top_post && (result == RMI_SUCCESS);
