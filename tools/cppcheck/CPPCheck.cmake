...
#
set(toolchain-xml
    "${SOURCE_DIR}/tools/cppcheck-aarch64-plaform.xml")

if(NOT EXISTS "${toolchain-xml}")
    message(FATAL_ERROR "No Cppcheck platform file is available for this compiler. Static "
