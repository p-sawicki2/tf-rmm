...
#
# RMM_MAX_NUM_DRAM_BANKS: Maximum number of DRAM banks allowed to be managed.
#
arm_config_option(
...
if (RMM_MAX_NUM_DRAM_BANKS EQUAL 0x0)
    message(FATAL_ERROR "RMM_MAX_NUM_DRAM_BANKS not configured")
endif()
