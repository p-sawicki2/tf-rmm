...
/*
 * Element size in the HES attestation queue must be
 * sizeof(hes_attest_request_s), rounded up to the next power of two
 */
#define HES_ATTEST_QUEUE_ELEMENT_SIZE 0x80
