...
#define SYSREG_READ_MASKED(reg)		\
	(read_ID_AA64##reg##_EL1() &	\
	~(ID_AA64##reg##_EL1_MASK))

#define SYSREG_READ_MASKED_SET(reg)	\
	((read_ID_AA64##reg##_EL1() &	\
	~(ID_AA64##reg##_EL1_MASK)) |	\
	 (ID_AA64##reg##_EL1_SET))

/* System registers ID_AA64xxx_EL1 feature masks and set values */
#define ID_AA64AFR0_EL1_MASK	~0UL
#define ID_AA64AFR1_EL1_MASK	~0UL
#define ID_AA64DFR1_EL1_MASK	~0UL
#define ID_AA64ISAR0_EL1_MASK	~0UL
#define ID_AA64MMFR0_EL1_MASK	~0UL
#define ID_AA64MMFR1_EL1_MASK	~0UL
#define ID_AA64MMFR2_EL1_MASK	~0UL
#define ID_AA64PFR1_EL1_MASK	~0UL
 ...
 */
#define ID_AA64DFR0_EL1_MASK			  \
	ID_AA64DFR0_EL1_DebugVer_MASK		| \
	ID_AA64DFR0_EL1_TraceVer_MASK		| \
	ID_AA64DFR0_EL1_PMUVer_MASK		| \
	ID_AA64DFR0_EL1_BRPs_MASK		| \
	ID_AA64DFR0_EL1_PMSS_MASK		| \
	ID_AA64DFR0_EL1_WRPs_MASK		| \
	ID_AA64DFR0_EL1_SEBEP_MASK		| \
	...
	ID_AA64DFR0_EL1_ExtTrcBuff_MASK		| \
				  ...
				  unsigned long esr)
{
	...
	switch (idreg) {
	SYSREG_CASE(AFR0)
		value = SYSREG_READ_MASKED(AFR0);
		break;
	SYSREG_CASE(AFR1)
		value = SYSREG_READ_MASKED(AFR1);
		break;
	SYSREG_CASE(DFR0)
		value = SYSREG_READ_MASKED_SET(DFR0);
		break;
	SYSREG_CASE(DFR1)
		value = SYSREG_READ_MASKED(DFR1);
		break;
	SYSREG_CASE(ISAR0)
		value = SYSREG_READ_MASKED(ISAR0);
		break;
	SYSREG_CASE(ISAR1)
		value = SYSREG_READ_MASKED(ISAR1);
		break;
	SYSREG_CASE(MMFR0)
		value = SYSREG_READ_MASKED(MMFR0);
		break;
	SYSREG_CASE(MMFR1)
		value = SYSREG_READ_MASKED(MMFR1);
		break;
	SYSREG_CASE(MMFR2)
		value = SYSREG_READ_MASKED(MMFR2);
		break;
	SYSREG_CASE(PFR0)
		/*
		 ...
		 */
		value = SYSREG_READ_MASKED(PFR0);
		break;
	SYSREG_CASE(PFR1)
		value = SYSREG_READ_MASKED(PFR1);
		break;
	/*
