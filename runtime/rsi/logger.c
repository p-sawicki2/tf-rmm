...
static const struct rsi_handler rsi_logger[] = {
	{.fn_name = RSI_FUNCTION(_VERSION), .num_args = 1U, .num_vals = 2U},
	{.fn_name = RSI_FUNCTION(_FEATURES), .num_args = 1U, .num_vals = 1U},
	{.fn_name = RSI_FUNCTION(_MEASUREMENT_READ), .num_args = 1U, .num_vals = 8U},
	{.fn_name = RSI_FUNCTION(_MEASUREMENT_EXTEND), .num_args = 10U, .num_vals = 0U},
	{.fn_name = RSI_FUNCTION(_ATTEST_TOKEN_INIT), .num_args = 8U, .num_vals = 1U},
	{.fn_name = RSI_FUNCTION(_ATTEST_TOKEN_CONTINUE), .num_args = 3U, .num_vals = 1U},
	{.fn_name = RSI_FUNCTION(_REALM_CONFIG), .num_args = 1U, .num_vals = 0U},
	{.fn_name = RSI_FUNCTION(_IPA_STATE_SET), .num_args = 4U, .num_vals = 2U},
	{.fn_name = RSI_FUNCTION(_IPA_STATE_GET), .num_args = 1U, .num_vals = 1U},
	{.fn_name = RSI_FUNCTION(_HOST_CALL), .num_args = 1U, .num_vals = 0U},
};
