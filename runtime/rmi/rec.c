...
/* Initialise the heap for attestation */
static void rec_attestation_heap_init(struct rec *rec)
{
	attestation_heap_ctx_assign_pe(&rec->aux_data.attest_data->ctx);
...
static void rec_aux_granules_map_and_init(struct rec *rec)
{
	void *rec_aux;
			     ...
			     unsigned long rec_params_addr)
{
	...
	/* Map REC aux granules and initialize aux data */
	rec_aux_granules_map_and_init(rec);
