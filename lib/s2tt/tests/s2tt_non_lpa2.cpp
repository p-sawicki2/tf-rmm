...
TEST(s2tt_non_lpa2, s2tte_create_unassigned_tc1)
{
	s2tte_create_unassigned_tc1();
}

TEST(s2tt_non_lpa2, s2tte_create_assigned_tc1)
{
	s2tte_create_assigned_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_create_assigned_tc2)
{
	s2tte_create_assigned_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_create_assigned_tc3)
{
	s2tte_create_assigned_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_create_assigned_tc4)
{
	s2tte_create_assigned_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_create_assigned_tc5)
{
	s2tte_create_assigned_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_create_assigned_tc6)
{
	s2tte_create_assigned_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_create_assigned_tc7)
{
	s2tte_create_assigned_tc7();
}
...
ASSERT_TEST(s2tt_non_lpa2, invalidate_page_tc1)
{
	invalidate_page_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, invalidate_block_tc1)
{
	invalidate_block_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, invalidate_pages_in_block_tc1)
{
	invalidate_pages_in_block_tc1();
}

TEST(s2tt_non_lpa2, table_is_unassigned_empty_block_tc1)
{
	table_is_unassigned_empty_block_tc1();
}

TEST(s2tt_non_lpa2, table_is_unassigned_empty_block_tc2)
{
	table_is_unassigned_empty_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, table_is_unassigned_empty_block_tc3)
{
	table_is_unassigned_empty_block_tc3();
}

TEST(s2tt_non_lpa2, table_is_unassigned_ram_block_tc1)
{
	table_is_unassigned_ram_block_tc1();
}

TEST(s2tt_non_lpa2, table_is_unassigned_ram_block_tc2)
{
	table_is_unassigned_ram_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, table_is_unassigned_ram_block_tc3)
{
	table_is_unassigned_ram_block_tc3();
}

TEST(s2tt_non_lpa2, table_is_unassigned_ns_block_tc1)
{
	table_is_unassigned_ns_block_tc1();
}

TEST(s2tt_non_lpa2, table_is_unassigned_ns_block_tc2)
{
	table_is_unassigned_ns_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, table_is_unassigned_ns_block_tc3)
{
	table_is_unassigned_ns_block_tc3();
}

TEST(s2tt_non_lpa2, table_is_unassigned_destroyed_block_tc1)
{
	table_is_unassigned_destroyed_block_tc1();
}

TEST(s2tt_non_lpa2, table_is_unassigned_destroyed_block_tc2)
{
	table_is_unassigned_destroyed_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, table_is_unassigned_destroyed_block_tc3)
{
	table_is_unassigned_destroyed_block_tc3();
}

TEST(s2tt_non_lpa2, table_maps_assigned_empty_block_tc1)
{
	table_maps_assigned_empty_block_tc1();
}

TEST(s2tt_non_lpa2, table_maps_assigned_empty_block_tc2)
{
	table_maps_assigned_empty_block_tc2();
}

TEST(s2tt_non_lpa2, table_maps_assigned_empty_block_tc3)
{
	table_maps_assigned_empty_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_empty_block_tc4)
{
	table_maps_assigned_empty_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_empty_block_tc5)
{
	table_maps_assigned_empty_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_empty_block_tc6)
{
	table_maps_assigned_empty_block_tc6();
}

TEST(s2tt_non_lpa2, table_maps_assigned_ram_block_tc1)
{
	table_maps_assigned_ram_block_tc1();
}

TEST(s2tt_non_lpa2, table_maps_assigned_ram_block_tc2)
{
	table_maps_assigned_ram_block_tc2();
}

TEST(s2tt_non_lpa2, table_maps_assigned_ram_block_tc3)
{
	table_maps_assigned_ram_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_ram_block_tc4)
{
	table_maps_assigned_ram_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_ram_block_tc5)
{
	table_maps_assigned_ram_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_ram_block_tc6)
{
	table_maps_assigned_ram_block_tc6();
}

TEST(s2tt_non_lpa2, table_maps_assigned_ns_block_tc1)
{
	table_maps_assigned_ns_block_tc1();
}

TEST(s2tt_non_lpa2, table_maps_assigned_ns_block_tc2)
{
	table_maps_assigned_ns_block_tc2();
}

TEST(s2tt_non_lpa2, table_maps_assigned_ns_block_tc3)
{
	table_maps_assigned_ns_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_ns_block_tc4)
{
	table_maps_assigned_ns_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_ns_block_tc5)
{
	table_maps_assigned_ns_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_ns_block_tc6)
{
	table_maps_assigned_ns_block_tc6();
}

TEST(s2tt_non_lpa2, table_maps_assigned_destroyed_block_tc1)
{
	table_maps_assigned_destroyed_block_tc1();
}

TEST(s2tt_non_lpa2, table_maps_assigned_destroyed_block_tc2)
{
	table_maps_assigned_destroyed_block_tc2();
}

TEST(s2tt_non_lpa2, table_maps_assigned_destroyed_block_tc3)
{
	table_maps_assigned_destroyed_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_destroyed_block_tc4)
{
	table_maps_assigned_destroyed_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_destroyed_block_tc5)
{
	table_maps_assigned_destroyed_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, table_maps_assigned_destroyed_block_tc6)
{
	table_maps_assigned_destroyed_block_tc6();
}

TEST(s2tt_non_lpa2, skip_non_live_entries_tc1)
{
	skip_non_live_entries_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, skip_non_live_entries_tc2)
{
	skip_non_live_entries_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, skip_non_live_entries_tc3)
{
	skip_non_live_entries_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, skip_non_live_entries_tc4)
{
	skip_non_live_entries_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, skip_non_live_entries_tc5)
{
	skip_non_live_entries_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, skip_non_live_entries_tc6)
{
	skip_non_live_entries_tc6();
}

TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc1)
{
	rtt_walk_lock_unlock_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc2)
{
	rtt_walk_lock_unlock_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc3)
{
	rtt_walk_lock_unlock_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc4)
{
	rtt_walk_lock_unlock_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc5)
{
	rtt_walk_lock_unlock_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc6)
{
	rtt_walk_lock_unlock_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc7)
{
	rtt_walk_lock_unlock_tc7();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc8)
{
	rtt_walk_lock_unlock_tc8();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc9)
{
	rtt_walk_lock_unlock_tc9();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc10)
{
	rtt_walk_lock_unlock_tc10();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc11)
{
	rtt_walk_lock_unlock_tc11();
}

ASSERT_TEST(s2tt_non_lpa2, rtt_walk_lock_unlock_tc12)
{
