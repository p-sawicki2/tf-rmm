...
TEST(s2tt_non_lpa2, s2tte_is_addr_lvl_aligned_tc1)
{
	s2tte_is_addr_lvl_aligned_tc1();
}

TEST(s2tt_non_lpa2, s2tte_is_addr_lvl_aligned_tc2)
{
	s2tte_is_addr_lvl_aligned_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_is_addr_lvl_aligned_tc3)
{
	s2tte_is_addr_lvl_aligned_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_is_addr_lvl_aligned_tc4)
{
	s2tte_is_addr_lvl_aligned_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_is_addr_lvl_aligned_tc5)
{
...
TEST(s2tt_non_lpa2, s2tt_is_unassigned_empty_block_tc1)
{
	s2tt_is_unassigned_empty_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_empty_block_tc2)
{
	s2tt_is_unassigned_empty_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_is_unassigned_empty_block_tc3)
{
	s2tt_is_unassigned_empty_block_tc3();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_ram_block_tc1)
{
	s2tt_is_unassigned_ram_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_ram_block_tc2)
{
	s2tt_is_unassigned_ram_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_is_unassigned_ram_block_tc3)
{
	s2tt_is_unassigned_ram_block_tc3();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_ns_block_tc1)
{
	s2tt_is_unassigned_ns_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_ns_block_tc2)
{
	s2tt_is_unassigned_ns_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_is_unassigned_ns_block_tc3)
{
	s2tt_is_unassigned_ns_block_tc3();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_destroyed_block_tc1)
{
	s2tt_is_unassigned_destroyed_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_is_unassigned_destroyed_block_tc2)
{
	s2tt_is_unassigned_destroyed_block_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_is_unassigned_destroyed_block_tc3)
{
	s2tt_is_unassigned_destroyed_block_tc3();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc1)
{
	s2tt_maps_assigned_empty_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc2)
{
	s2tt_maps_assigned_empty_block_tc2();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc3)
{
	s2tt_maps_assigned_empty_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc4)
{
	s2tt_maps_assigned_empty_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc5)
{
	s2tt_maps_assigned_empty_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc6)
{
	s2tt_maps_assigned_empty_block_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_empty_block_tc7)
{
	s2tt_maps_assigned_empty_block_tc7();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc1)
{
	s2tt_maps_assigned_ram_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc2)
{
	s2tt_maps_assigned_ram_block_tc2();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc3)
{
	s2tt_maps_assigned_ram_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc4)
{
	s2tt_maps_assigned_ram_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc5)
{
	s2tt_maps_assigned_ram_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc6)
{
	s2tt_maps_assigned_ram_block_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ram_block_tc7)
{
	s2tt_maps_assigned_ram_block_tc7();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc1)
{
	s2tt_maps_assigned_ns_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc2)
{
	s2tt_maps_assigned_ns_block_tc2();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc3)
{
	s2tt_maps_assigned_ns_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc4)
{
	s2tt_maps_assigned_ns_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc5)
{
	s2tt_maps_assigned_ns_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc6)
{
	s2tt_maps_assigned_ns_block_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_ns_block_tc7)
{
	s2tt_maps_assigned_ns_block_tc7();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc1)
{
	s2tt_maps_assigned_destroyed_block_tc1();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc2)
{
	s2tt_maps_assigned_destroyed_block_tc2();
}

TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc3)
{
	s2tt_maps_assigned_destroyed_block_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc4)
{
	s2tt_maps_assigned_destroyed_block_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc5)
{
	s2tt_maps_assigned_destroyed_block_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc6)
{
	s2tt_maps_assigned_destroyed_block_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_maps_assigned_destroyed_block_tc7)
{
...
ASSERT_TEST(s2tt_non_lpa2, s2tt_skip_non_live_entries_tc7)
{
