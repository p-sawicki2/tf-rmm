...
ASSERT_TEST(s2tt_lpa2, addr_is_level_aligned_tc5)
{
...
ASSERT_TEST(s2tt_lpa2, s2tt_invalidate_page_tc1)
{
	s2tt_invalidate_page_tc1();
}

ASSERT_TEST(s2tt_lpa2, s2tt_invalidate_block_tc1)
{
	s2tt_invalidate_block_tc1();
}

ASSERT_TEST(s2tt_lpa2, s2tt_invalidate_pages_in_block_tc1)
{
	s2tt_invalidate_pages_in_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_empty_block_tc1)
{
	s2tt_table_is_unassigned_empty_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_empty_block_tc2)
{
	s2tt_table_is_unassigned_empty_block_tc2();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_is_unassigned_empty_block_tc3)
{
	s2tt_table_is_unassigned_empty_block_tc3();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_ram_block_tc1)
{
	s2tt_table_is_unassigned_ram_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_ram_block_tc2)
{
	s2tt_table_is_unassigned_ram_block_tc2();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_is_unassigned_ram_block_tc3)
{
	s2tt_table_is_unassigned_ram_block_tc3();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_ns_block_tc1)
{
	s2tt_table_is_unassigned_ns_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_ns_block_tc2)
{
	s2tt_table_is_unassigned_ns_block_tc2();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_is_unassigned_ns_block_tc3)
{
	s2tt_table_is_unassigned_ns_block_tc3();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_destroyed_block_tc1)
{
	s2tt_table_is_unassigned_destroyed_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_is_unassigned_destroyed_block_tc2)
{
	s2tt_table_is_unassigned_destroyed_block_tc2();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_is_unassigned_destroyed_block_tc3)
{
	s2tt_table_is_unassigned_destroyed_block_tc3();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_empty_block_tc1)
{
	s2tt_table_maps_assigned_empty_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_empty_block_tc2)
{
	s2tt_table_maps_assigned_empty_block_tc2();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_empty_block_tc3)
{
	s2tt_table_maps_assigned_empty_block_tc3();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_empty_block_tc4)
{
	s2tt_table_maps_assigned_empty_block_tc4();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_empty_block_tc5)
{
	s2tt_table_maps_assigned_empty_block_tc5();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_empty_block_tc6)
{
	s2tt_table_maps_assigned_empty_block_tc6();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_ram_block_tc1)
{
	s2tt_table_maps_assigned_ram_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_ram_block_tc2)
{
	s2tt_table_maps_assigned_ram_block_tc2();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_ram_block_tc3)
{
	s2tt_table_maps_assigned_ram_block_tc3();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_ram_block_tc4)
{
	s2tt_table_maps_assigned_ram_block_tc4();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_ram_block_tc5)
{
	s2tt_table_maps_assigned_ram_block_tc5();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_ram_block_tc6)
{
	s2tt_table_maps_assigned_ram_block_tc6();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_ns_block_tc1)
{
	s2tt_table_maps_assigned_ns_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_ns_block_tc2)
{
	s2tt_table_maps_assigned_ns_block_tc2();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_ns_block_tc3)
{
	s2tt_table_maps_assigned_ns_block_tc3();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_ns_block_tc4)
{
	s2tt_table_maps_assigned_ns_block_tc4();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_ns_block_tc5)
{
	s2tt_table_maps_assigned_ns_block_tc5();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_ns_block_tc6)
{
	s2tt_table_maps_assigned_ns_block_tc6();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_destroyed_block_tc1)
{
	s2tt_table_maps_assigned_destroyed_block_tc1();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_destroyed_block_tc2)
{
	s2tt_table_maps_assigned_destroyed_block_tc2();
}

TEST(s2tt_lpa2, s2tt_table_maps_assigned_destroyed_block_tc3)
{
	s2tt_table_maps_assigned_destroyed_block_tc3();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_destroyed_block_tc4)
{
	s2tt_table_maps_assigned_destroyed_block_tc4();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_destroyed_block_tc5)
{
	s2tt_table_maps_assigned_destroyed_block_tc5();
}

ASSERT_TEST(s2tt_lpa2, s2tt_table_maps_assigned_destroyed_block_tc6)
{
