...
void s2tte_create_assigned_ns_tc2(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_create_assigned_ns(s2tt_test_helpers_pa_to_s2tte(pa, level)
...
void s2tte_create_assigned_ns_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	/*
	 * Use 'level - 1L' on the call to s2tt_test_helpers_pa_to_s2tte()
	 * as otherwise it would trigger a false positive.
	 */
	(void)s2tte_create_assigned_ns(
			s2tt_test_helpers_pa_to_s2tte(pa, level - 1L), level);
	test_helpers_fail_if_no_assert_failed();
}
...
void host_ns_s2tte_is_valid_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(host_ns_s2tte_is_valid(tte, level));
	}
}
...
void s2tte_is_unassigned_destroyed_tc1(void)
{
	...
	cb_idx = (unsigned int)test_helpers_get_rand_in_range(
					0UL, ARRAY_SIZE(unassigned_cbs) - 1UL);
	inv_tte = unassigned_cbs[cb_idx]();
	CHECK_FALSE(s2tte_is_unassigned_destroyed(inv_tte));
}
...
void s2tt_is_addr_lvl_aligned_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		CHECK_TRUE(s2tt_is_addr_lvl_aligned(pa, level));
	}
}

void s2tt_is_addr_lvl_aligned_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		CHECK_TRUE(s2tt_is_addr_lvl_aligned(pa, level) == false);
	}
}

void s2tt_is_addr_lvl_aligned_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Given a valid PA, call s2tt_is_addr_lvl_aligned() with a level
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_is_addr_lvl_aligned(pa, level);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_is_addr_lvl_aligned_tc4(void)
{
	/***************************************************************
	 * TEST CASE 4:
	 *
...
void s2tt_invalidate_pages_in_block_tc1(void)
{
	 ...
	 * TEST CASE 1:
	 *
	 * Invoke s2tt_invalidate_pages_in_block() with a valid address and
...
void s2tt_is_unassigned_empty_block_tc1(void)
{
	 ...
	 * s2tt_is_unassigned_empty_block() returns the expected value
	 ***************************************************************/
	...
	CHECK_TRUE(s2tt_is_unassigned_empty_block(&s2tt[0U]));
}
...
void s2tt_is_unassigned_empty_block_tc2(void)
{
	...
	CHECK_FALSE(s2tt_is_unassigned_empty_block(&s2tt[0U]));
...
void s2tt_is_unassigned_empty_block_tc3(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_is_unassigned_empty_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_is_unassigned_ram_block_tc1(void)
{
	...
	CHECK_TRUE(s2tt_is_unassigned_ram_block(&s2tt[0U]));
}
...
void s2tt_is_unassigned_ram_block_tc2(void)
{
	 ...
	 */
	s2tt[tte_idx] = unassigned_cbs[cb_idx]();
	CHECK_FALSE(s2tt_is_unassigned_ram_block(&s2tt[0U]));
...
void s2tt_is_unassigned_ram_block_tc3(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_is_unassigned_ram_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_is_unassigned_ns_block_tc1(void)
{
	...
	CHECK_TRUE(s2tt_is_unassigned_ns_block(&s2tt[0U]));
}
...
void s2tt_is_unassigned_ns_block_tc2(void)
{
	 ...
	 */
	s2tt[tte_idx] = unassigned_cbs[cb_idx]();
	CHECK_FALSE(s2tt_is_unassigned_ns_block(&s2tt[0U]));
...
void s2tt_is_unassigned_ns_block_tc3(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_is_unassigned_ns_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_is_unassigned_destroyed_block_tc1(void)
{
	...
	CHECK_TRUE(s2tt_is_unassigned_destroyed_block(&s2tt[0U]));
}
...
void s2tt_is_unassigned_destroyed_block_tc2(void)
{
	 ...
	 */
	s2tt[tte_idx] = unassigned_cbs[cb_idx]();
	CHECK_FALSE(s2tt_is_unassigned_destroyed_block(&s2tt[0U]));
...
void s2tt_is_unassigned_destroyed_block_tc3(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_is_unassigned_destroyed_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_empty_block_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_maps_assigned_empty_block(&s2tt[0U], level));
	}
}
...
void s2tt_maps_assigned_empty_block_tc2(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		s2tt[tte_idx] = unassigned_cbs[cb_idx]();
		CHECK_FALSE(s2tt_maps_assigned_empty_block(&s2tt[0U], level));
...
void s2tt_maps_assigned_empty_block_tc3(void)
{
	...
	} while (s2tt_is_addr_lvl_aligned(pa, level - 1L));
...
void s2tt_maps_assigned_empty_block_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_empty_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_empty_block_tc5(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_empty_block(NULL, level + 1UL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_ram_block_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_maps_assigned_ram_block(&s2tt[0U], level));
	}
}
...
void s2tt_maps_assigned_ram_block_tc2(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = unassigned_cbs[cb_idx]();
		CHECK_FALSE(s2tt_maps_assigned_ram_block(&s2tt[0U], level));
...
void s2tt_maps_assigned_ram_block_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_ram_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_ram_block_tc5(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_ram_block(NULL, level + 1UL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_ns_block_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_maps_assigned_ns_block(&s2tt[0U], level));
	}
}
...
void s2tt_maps_assigned_ns_block_tc2(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = unassigned_cbs[cb_idx]();
		CHECK_FALSE(s2tt_maps_assigned_ns_block(&s2tt[0U], level));
...
void s2tt_maps_assigned_ns_block_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_ns_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_ns_block_tc6(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_ns_block(NULL, level - 1UL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_destroyed_block_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_maps_assigned_destroyed_block(&s2tt[0U],
								level));
	}
}
...
void s2tt_maps_assigned_destroyed_block_tc2(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = unassigned_cbs[cb_idx]();
		CHECK_FALSE(s2tt_maps_assigned_destroyed_block(&s2tt[0U],
								level));
...
void s2tt_maps_assigned_destroyed_block_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_destroyed_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_maps_assigned_destroyed_block_tc5(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_maps_assigned_destroyed_block(NULL, level + 1UL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_skip_non_live_entries_tc4(void)
{
	 ...
	 * TEST CASE 4:
	 *
	 * Call s2tt_skip_non_live_entries() with a s2tt_walk struct in which
 ...
 * level supported for stage 2 lookup will be '-1', therefore an offset of one
 * possition will be added to all the indexes used to index the
 * *_per_lvl arrays to compensate for this negative value. This offset will be
 * applied even when FEAT_LPA2 is not available and the SL is '0'.
 */
			   ...
			   struct granule *str_granule_base)
{
	...
	for (level = sl; level <= end_lvl; level++) {
		...
		if (level == sl) {
			 ...
			 * We nitialize as assigned-ram for no particular
			 * reason.
			 */
	 ...
	 * keeping into account that the level after the start one have
...
void s2tt_walk_lock_unlock_tc1(void)
{
	...
	s2tt_walk_lock_unlock(g_tables[sl + 1U], sl, s2tt_max_ipa_size(), pa,
			     end_level, &wi);
	 ...
	 */
	s2tt_walk_lock_unlock(g_tables[sl + 2UL], sl + 1L,
			     s2tt_max_ipa_size(), pa, end_level, &wi);
	...
	s2tt_walk_lock_unlock(g_tables[sl + 1U], sl, s2tt_max_ipa_size(),
			     pa, end_level - 1U, &wi);
	 ...
	 * starting on the next starting level.
	 */
	s2tt_walk_lock_unlock(g_tables[sl + 2L], sl + 1L, s2tt_max_ipa_size(),
			     pa, end_level, &wi);
	 ...
	 * starting on the next starting level.
	 */
	s2tt_walk_lock_unlock(g_tables[sl + 2U], sl + 1L, s2tt_max_ipa_size(),
			     pa, end_level, &wi);
...
void s2tt_walk_lock_unlock_tc4(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(NULL, sl, s2tt_max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_walk_lock_unlock_tc6(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(g_tables[sl + 1U], sl - 1L, s2tt_max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_walk_lock_unlock_tc7(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(g_tables[sl + 1U], end_level + 1L, s2tt_max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_walk_lock_unlock_tc8(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(g_tables[sl + 1U + 1U], sl + 1L, s2tt_max_ipa_size(),
			     pa, sl - 1U, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_walk_lock_unlock_tc11(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(g_tables[sl + 1U], sl, (s2tt_max_ipa_size() + 1UL),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_walk_lock_unlock_tc12(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(g_tables[sl + 2U], sl + 2L, s2tt_max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
