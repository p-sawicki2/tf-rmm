...
void s2tt_init_unassigned_empty_tc1(void)
{
	...
	for (unsigned int i = 0U; i < S2TTES_PER_S2TT; i++) {
		val_s2tt[i] =
			s2tte_create_unassigned(S2TTE_INVALID_RIPAS_RAM);
	}
...
void s2tt_init_unassigned_empty_tc2(void)
{
	 ...
	 * TEST CASE 2:
	 *
	 * Invoke s2tt_init_unassigned_empty() passing a NULL pointer.
	 ***************************************************************/
...
void s2tt_init_unassigned_ram_tc1(void)
{
	 ...
	 * TEST CASE 1:
	 *
	 * Initialize a table unassigned ram S2TTEs and validate its
	 * content.
	 ***************************************************************/
	...
	/* Generate the validation table */
	for (unsigned int i = 0U; i < S2TTES_PER_S2TT; i++) {
		val_s2tt[i] = s2tte_create_unassigned(S2TTE_INVALID_RIPAS_RAM);
	}
...
void s2tt_init_unassigned_ns_tc1(void)
{
	...
	/* Generate the validation table */
	for (unsigned int i = 0U; i < S2TTES_PER_S2TT; i++) {
		val_s2tt[i] = s2tte_create_unassigned(S2TTE_UNASSIGNED_NS);
	}
...
void s2tte_pa_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_pa(tte, s2tt_test_helpers_min_table_lvl() - 1L);
	test_helpers_fail_if_no_assert_failed();
}
