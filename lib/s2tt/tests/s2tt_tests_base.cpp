...
void s2tte_create_unassigned_ns_tc1(void)
{
	...
	unsigned long expected_tte = S2TTE_INVALID_RIPAS_NS |
				     S2TTE_INVALID_HIPAS_UNASSIGNED;
...
void s2tte_create_assigned_ram_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_create_assigned_ram((const struct context_ctx *)&s2tt_ctx,
					pa, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tte_create_assigned_ram_tc5(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_create_assigned_ram((const struct context_ctx *)NULL,
					pa, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tte_create_assigned_ns_tc1(void)
{
	...
	for (long i = s2tt_test_helpers_min_block_lvl();
		...
		unsigned long attrs = s2tt_test_helpers_gen_ns_attrs(false,
								     false);
		/*
		 * s2tt_create_assigned_ns() does not make use of the
...
void s2tte_create_assigned_ns_tc2(void)
{
	 ...
	 * attributes not set by the host different to 0.
	 ***************************************************************/
...
void s2tte_create_assigned_ns_tc3(void)
{
	 ...
	 * it is safe to just pass a NULL pointer.
	 */
	(void)s2tte_create_assigned_ns((const struct s2tte_context *)NULL,
					pa, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tte_create_table_tc5(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_create_table((const struct s2tt_context *)&s2tt_ctx,
				 pa, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void host_ns_s2tte_is_valid_tc2(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_FALSE(host_ns_s2tte_is_valid(tte, level));
	}
}
...
void host_ns_s2tte_tc3(void)
{
	...
	struct s2tt_context s2tt_ctx = {OUL};
	 ...
	 */
	s2tt_ctx.enable_lpa2 = s2tt_test_helpers_lpa2_enabled();
	(void)host_ns_s2tte((const struct s2tt_context *)NULL, tte, level + 1L);
	test_helpers_fail_if_no_assert_failed();
}
...
static unsigned long test_create_assigned(unsigned long pa,
					  long level,
					  unsigned long ripas)
{
	if ((ripas == S2TTE_INVALID_RIPAS_EMPTY) ||
	    (ripas == S2TTE_INVALID_RIPAS_DESTROYED)) {
		return s2tte_create_assigned(pa, level, ripas);
	} else if (ripas == S2TTE_INVALID_RIPAS_RAM) {
		return s2tte_create_assigned_ram(pa, level);
	}

	return s2tte_create_assigned_ns(pa, level);
}
...
void s2tte_has_ripas_tc2(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		tte = s2tte_create_unassigned(S2TTE_UNASSIGNED_NS);
		CHECK_TRUE(s2tte_has_ripas((const struct s2tt_context *)NULL,
					   tte, level) == false);
		 ...
		 */
		tte = s2tte_create_unassigned(S2TTE_INVALID_RIPAS_EMPTY);
		tte &= ~S2TTE_INVALID_RIPAS_MASK;
		 ...
		 */
		tte = s2tte_create_assigned(pa, level,
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		tte = s2tte_create_table(0UL, level);
...
void s2tte_has_ripas_tc3(void)
{
	...
	unsigned long tte = s2tte_create_unassigned(S2TTE_INVALID_RIPAS_RAM);

	test_helpers_expect_assert_fail(true);
	(void)s2tte_has_ripas((const struct s2tt_context *)NULL,
...
void s2tte_has_ripas_tc4(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_has_ripas((const struct s2tt_context *)NULL,
			      tte, S2TT_TEST_HELPERS_MAX_LVL + 1L);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tte_is_unassigned_tc1(void)
{
	...
	unsigned long inv_tte, tte = s2tte_create_unassigned(ripas[ripas_idx]);
...
void s2tte_is_unassigned_empty_tc1(void)
{
	...
	unsigned long tte = s2tte_create_unassigned(S2TTE_INVALID_RIPAS_EMPTY);
	...
	idx = (unsigned int)test_helpers_get_rand_in_range(
					0UL, ARRAY_SIZE(ripas) - 1UL);
	inv_tte = s2tte_create_unassigned(ripas[idx]);
	CHECK_TRUE(s2tte_is_unassigned_empty((const struct s2tt_context *)NULL, inv_tte) == false);
}
...
void s2tte_is_unassigned_ns_tc1(void)
{
	...
	unsigned int idx;
	unsigned long inv_tte;
	unsigned long tte = s2tte_create_unassigned(S2TTE_UNASSIGNED_NS);
...
void s2tte_is_unassigned_destroyed_tc1(void)
{
	...
	unsigned long inv_tte;
	unsigned long tte =
		s2tte_create_unassigned(S2TTE_INVALID_RIPAS_DESTROYED);
...
void s2tte_is_assigned_empty_tc1(void)
{
	...
	unsigned long ripas[] = {S2TTE_UNASSIGNED_NS,
				 S2TTE_INVALID_RIPAS_RAM,
				 S2TTE_INVALID_RIPAS_DESTROYED};
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		unsigned long inv_tte, tte =
			s2tte_create_assigned(pa, level,
					      S2TTE_INVALID_RIPAS_EMPTY);

		/* Validate s2tt_is_assigned_empty with a valid TTE */
		CHECK_TRUE(s2tte_is_assigned_empty((const struct s2tt_context *)NULL,
						   tte, level) == true);
		...
		idx = (unsigned int)test_helpers_get_rand_in_range(
					0UL, ARRAY_SIZE(ripas) - 1UL);
		inv_tte = test_create_assigned(pa, level, ripas[idx]);
		CHECK_TRUE(s2tte_is_assigned_empty((const struct s2tt_context *)NULL,
					inv_tte, level) == false);
	}
}
...
void s2tte_is_assigned_ns_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tte_is_assigned_ns((const struct s2tt_context *)NULL,
						tte, level) == true);
		 ...
		 */
		inv_tte = s2tte_create_unassigned(S2TTE_UNASSIGNED_NS);
		CHECK_TRUE(s2tte_is_assigned_ns((const struct s2tt_context *)NULL,
						inv_tte, level) == false);
...
void s2tte_is_assigned_ns_tc2(void)
{
	...
	tte = s2tte_create_assigned_ns(s2tt_test_helpers_pa_to_s2tte(pa, level) | tte,
					level);

	/* Validate s2tt_is_assigned_ns with a valid TTE */
	CHECK_FALSE(s2tte_is_assigned_ns((const struct s2tt_context *)NULL, tte,
...
void s2tte_is_assigned_ram_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Validate s2tt_is_assigned_empty with a valid TTE */
		CHECK_TRUE(s2tte_is_assigned_ram((const struct s2tt_context *)NULL,
						 tte, level) == true);
		 ...
		 * a HIPAS other than ASSIGNED.
		 */
		inv_tte = s2tte_create_unassigned(S2TTE_INVALID_RIPAS_RAM);
		CHECK_TRUE(s2tte_is_assigned_ram((const struct s2tt_context *)NULL,
						 inv_tte, level) == false);
...
void s2tte_is_assigned_ram_tc2(void)
{
	...
	CHECK_FALSE(s2tte_is_assigned_ram((const struct s2tt_context *)NULL,
					  tte, s2tt_test_helpers_min_table_lvl()));
	CHECK_FALSE(s2tte_is_assigned_ram((const struct s2tt_context *)NULL,
...
void s2tte_is_assigned_destroyed_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tte_is_assigned_destroyed((const struct s2tt_context *)NULL,
							tte, level) == true);
...
void s2tte_is_table_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		if (level <= S2TT_TEST_HELPERS_MAX_TABLE_LVL) {
			...
			CHECK_TRUE(s2tte_is_table((const struct s2tt_context *)NULL,
						  tte, level) == true);
		} else {
			/*
...
void s2tte_get_ripas_tc1(void)
{
	...
	for (unsigned int i = 0U; i < ARRAY_SIZE(ripas); i++) {
		...
		UNSIGNED_LONGS_EQUAL((unsigned int)s2tte_get_ripas(
					(const struct s2tt_context *)NULL, tte),
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		*/
		...
		for (unsigned int i = 0U; i < S2TTES_PER_S2TT; i++) {
			...
			s2tte =	s2tte_create_assigned_ns(s2tte | attrs, level);
			pa += s2tte_map_size(level);
...
void s2tt_init_assigned_destroyed_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		for (unsigned int i = 0U; i < S2TTES_PER_S2TT; i++) {
			...
			s2tte =	s2tte_create_assigned(
					(const struct s2tt_context *)&s2tt_ctx,
					pa, level, S2TTE_INVALID_RIPAS_DESTROYED);
			pa += s2tte_map_size(level);
...
void s2tte_pa_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		if (level < s2tt_test_helpers_min_block_lvl()) {
			...
			tte = test_create_assigned(pa, level, ripas[idx]);
		}

		/* Verify the address returned by s2tte_pa() */
		UNSIGNED_LONGS_EQUAL((const struct s2tt_context *)&s2tt_ctx,
				     pa, s2tte_pa(tte, level));
	}
}
...
void s2tte_pa_tc2(void)
{
	...
	unsigned int idx = (unsigned int)test_helpers_get_rand_in_range(
					0UL, ARRAY_SIZE(ripas) - 1UL);
	unsigned long tte = s2tte_create_unassigned(ripas[idx]);
...
void s2tte_pa_tc3(void)
{
	...
	unsigned int idx = (unsigned int)test_helpers_get_rand_in_range(
					0UL, ARRAY_SIZE(ripas) - 1UL);
	unsigned long tte = test_create_assigned(pa, level, ripas[idx]);
...
void addr_is_level_aligned_tc1(void)
{
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		CHECK_TRUE(addr_is_level_aligned(
					(const struct s2tt_context *)&s2tt_ctx,
					pa, level));
	}
}
...
void addr_is_level_aligned_tc3(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)addr_is_level_aligned((const struct s2tt_context *)&s2tt_ctx,
				    pa, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void addr_is_level_aligned_tc5(void)
{
	/***************************************************************
	 * TEST CASE 5:
	 *
	 * Test addr_is_level_aligned() with a NULL
	 * s2tt_context pointer.
	 ***************************************************************/
	...
	test_helpers_expect_assert_fail(true);
	(void)addr_is_level_aligned((const struct s2tt_context *)NULL,
				    pa, level);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_table_is_unassigned_empty_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * Create an unassigned empty block and validate that
	 * s2tt_table_is_unassigned_empty_block() returns the expected
	 * value
	 ***************************************************************/
	...
	CHECK_TRUE(s2tt_table_is_unassigned_empty_block(&s2tt[0U]));
}

void s2tt_table_is_unassigned_empty_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * Set of negative tests:
	 *	- Validate s2tt_table_is_unassigned_empty_block() with an
	 ...
	 * unassigned S2TTE
	 */
	s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
	CHECK_FALSE(s2tt_table_is_unassigned_empty_block(&s2tt[0U]));
	 ...
	 */
	s2tt[tte_idx] = test_create_assigned(pa, level, assigned_ripas[idx]);
	CHECK_FALSE(s2tt_table_is_unassigned_empty_block(&s2tt[0U]));
}

void s2tt_table_is_unassigned_empty_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_is_unassigned_empty_block() with a NULL table.
	 ***************************************************************/

	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_is_unassigned_empty_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_is_unassigned_ram_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * Create an unassigned ram block and validate that
	 * s2tt_table_is_unassigned_ram_block() returns the expected value
	 ***************************************************************/
	...
	CHECK_TRUE(s2tt_table_is_unassigned_ram_block(&s2tt[0U]));
}

void s2tt_table_is_unassigned_ram_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * Set of negative tests:
	 *	- Validate s2tt_table_is_unassigned_ram_block() with an
	 ...
	 */
	s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
	CHECK_FALSE(s2tt_table_is_unassigned_ram_block(&s2tt[0U]));
...
void s2tt_table_is_unassigned_ram_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_is_unassigned_ram_block() with a NULL table.
	 ***************************************************************/

	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_is_unassigned_ram_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_is_unassigned_ns_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * Create an unassigned ns block and validate that
	 * s2tt_table_is_unassigned_ns_block() returns the expected value
	 ***************************************************************/
	...
	CHECK_TRUE(s2tt_table_is_unassigned_ns_block(&s2tt[0U]));
}

void s2tt_table_is_unassigned_ns_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * Set of negative tests:
	 *	- Validate s2tt_table_is_unassigned_ns_block() with an
	 ...
	 */
	s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
	CHECK_FALSE(s2tt_table_is_unassigned_ns_block(&s2tt[0U]));
...
void s2tt_table_is_unassigned_ns_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_is_unassigned_ns_block() with a NULL table.
	 ***************************************************************/

	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_is_unassigned_ns_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_is_unassigned_destroyed_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * Create an unassigned destroyed block and validate that
	 * s2tt_table_is_unassigned_destroyed_block() returns the
	 * expected value
	 ***************************************************************/
	...
	CHECK_TRUE(s2tt_table_is_unassigned_destroyed_block(&s2tt[0U]));
}

void s2tt_table_is_unassigned_destroyed_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * Set of negative tests:
	 *	- Validate s2tt_table_is_unassigned_destroyed_block() with
	 ...
	 */
	s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
	CHECK_FALSE(s2tt_table_is_unassigned_destroyed_block(&s2tt[0U]));
...
void s2tt_table_is_unassigned_destroyed_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_is_unassigned_destroyed_block() with a NULL table.
	 ***************************************************************/

	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_is_unassigned_destroyed_block(NULL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_empty_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * For each valid level, create an assigned empty block and
	 * validate that s2tt_table_maps_assigned_empty_block() returns
	 * the expected value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_table_maps_assigned_empty_block(&s2tt[0U], level));
	}
}

void s2tt_table_maps_assigned_empty_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 ...
	 * that s2tt_table_maps_assigned_empty_block() returns the expected
	 * value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
		CHECK_FALSE(s2tt_table_maps_assigned_empty_block(&s2tt[0U], level));
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = test_create_assigned(pa, level,
						     assigned_ripas[idx]);
		CHECK_FALSE(s2tt_table_maps_assigned_empty_block(&s2tt[0U], level));
	}
}

void s2tt_table_maps_assigned_empty_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_maps_assigned_empty_block() with the incorrect
	 * level.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_empty_block_tc4(void)
{
	/***************************************************************
	 * TEST CASE 4:
	 *
	 * Invoke s2tt_table_maps_assigned_empty_block() with a valid level
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_empty_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_empty_block_tc5(void)
{
	/***************************************************************
	 * TEST CASE 5:
	 *
	 * Invoke s2tt_table_maps_assigned_empty_block() with a level above
	 * the maximum allowed.
	 ***************************************************************/
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_empty_block(NULL, level + 1UL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_empty_block_tc6(void)
{
	/***************************************************************
	 * TEST CASE 6:
	 *
	 * Invoke s2tt_table_maps_assigned_empty_block() with a level below
	 * the minimum allowed.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_ram_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * For each valid level, create an assigned ram block and
	 * validate that s2tt_table_maps_assigned_ram_block() returns
	 * the expected value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_table_maps_assigned_ram_block(&s2tt[0U], level));
	}
}

void s2tt_table_maps_assigned_ram_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * For each valid level, create an assigned ram block and
	 * then change a random TTE to a different type to validate
	 * that s2tt_table_maps_assigned_ram_block() returns the expected
	 * value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
		CHECK_FALSE(s2tt_table_maps_assigned_ram_block(&s2tt[0U], level));
...
void s2tt_table_maps_assigned_ram_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_maps_assigned_ram_block() with the incorrect
	 * level.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_ram_block_tc4(void)
{
	/***************************************************************
	 * TEST CASE 4:
	 *
	 * Invoke s2tt_table_maps_assigned_ram_block() with a valid level
	 * and a NULL table pointer.
	 ***************************************************************/
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_ram_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_ram_block_tc5(void)
{
	/***************************************************************
	 * TEST CASE 5:
	 *
	 * Invoke s2tt_table_maps_assigned_ram_block() with a level above
	 * the maximum allowed.
	 ***************************************************************/
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_ram_block(NULL, level + 1UL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_ram_block_tc6(void)
{
	/***************************************************************
	 * TEST CASE 6:
	 *
	 * Invoke s2tt_table_maps_assigned_ram_block() with a level below
	 * the minimum allowed.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_ns_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * For each valid level, create an assigned ns block and
	 * validate that s2tt_table_maps_assigned_ns_block() returns
	 * the expected value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_table_maps_assigned_ns_block(&s2tt[0U], level));
	}
}

void s2tt_table_maps_assigned_ns_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * For each valid level, create an assigned ns block and
	 * then change a random TTE to a different type to validate
	 * that s2tt_table_maps_assigned_ns_block() returns the expected
	 * value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
		CHECK_FALSE(s2tt_table_maps_assigned_ns_block(&s2tt[0U], level));
...
void s2tt_table_maps_assigned_ns_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_maps_assigned_ns_block() with the incorrect
	 * level.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_ns_block_tc4(void)
{
	/***************************************************************
	 * TEST CASE 4:
	 *
	 * Invoke s2tt_table_maps_assigned_ns_block() with a valid level
	 * and a NULL table pointer.
	 ***************************************************************/
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_ns_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_ns_block_tc5(void)
{
	/***************************************************************
	 * TEST CASE 5:
	 *
	 * Invoke s2tt_table_maps_assigned_ns_block() with a level above
	 * the maximum allowed.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_ns_block_tc6(void)
{
	/***************************************************************
	 * TEST CASE 6:
	 *
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_ns_block(NULL, level - 1UL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_destroyed_block_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * For each valid level, create an assigned destroyed block and
	 * validate that s2tt_table_maps_assigned_destroyed_block() returns
	 * the expected value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		CHECK_TRUE(s2tt_table_maps_assigned_destroyed_block(&s2tt[0U],
								level));
	}
}

void s2tt_table_maps_assigned_destroyed_block_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	 * For each valid level, create an assigned destroyed block and
	 * then change a random TTE to a different type to validate
	 * that s2tt_table_maps_assigned_destroyed_block() returns the
	 * expected value
	 ***************************************************************/
	...
	for (long level = s2tt_test_helpers_min_block_lvl();
		...
		/* Alter a random S2TTE on the table */
		s2tt[tte_idx] = s2tte_create_unassigned(unassigned_ripas[idx]);
		CHECK_FALSE(s2tt_table_maps_assigned_destroyed_block(&s2tt[0U],
								level));
...
void s2tt_table_maps_assigned_destroyed_block_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	 * Invoke s2tt_table_maps_assigned_destroyed_block() with the
	 * incorrect level.
	 ***************************************************************/
...
void s2tt_table_maps_assigned_destroyed_block_tc4(void)
{
	/***************************************************************
	 * TEST CASE 4:
	 *
	 * Invoke s2tt_table_maps_assigned_destroyed_block() with a valid
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_destroyed_block(NULL, level);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_destroyed_block_tc5(void)
{
	/***************************************************************
	 * TEST CASE 5:
	 *
	 * Invoke s2tt_table_maps_assigned_destroyed_block() with a level
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_table_maps_assigned_destroyed_block(NULL, level + 1UL);
	test_helpers_fail_if_no_assert_failed();
}

void s2tt_table_maps_assigned_destroyed_block_tc6(void)
{
	/***************************************************************
	 * TEST CASE 6:
	 *
 ...
 *		      wi.index.
 *		wi: rtt_walk structure to pass to s2tt_skip_non_live_entries().
	...
	for (long level = s2tt_test_helpers_min_table_lvl();
		...
		for (unsigned int i = 0U; i < 3U; i++) {
			...
			if (level < s2tt_test_helpers_min_block_lvl()) {
				...
				s2tt[tte_idx] =
					test_create_assigned(entry_ipa, level, ripas[cb_idx]);
			}

			/* Validate s2tt_skip_non_live_entries() with current params */
			ret_ipa = s2tt_skip_non_live_entries(ipa, &s2tt[0U], &wi);
...
void s2tt_skip_non_live_entries_tc2(void)
{
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_skip_non_live_entries(0UL, NULL, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_skip_non_live_entries_tc3(void)
{
	 ...
	 * TEST CASE 3:
	 *
	 * Call s2tt_skip_non_live_entries() with a NULL rtt_walk struct
	 * pointer.
	 ***************************************************************/
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_skip_non_live_entries(0UL, &s2tt[0U], NULL);
	test_helpers_fail_if_no_assert_failed();
}
...
void s2tt_skip_non_live_entries_tc4(void)
{
	 ...
	 * TEST CASE 4:
	 *
	 * Call s2tt_skip_non_live_entries() with a rtt_walk struct in which
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tt_skip_non_live_entries(0UL, &s2tt[0U], &wi);
	test_helpers_fail_if_no_assert_failed();
}
		...
		if (level == sl) {
			...
			for (unsigned int i = 0U;
				...
				child_pa = (granule_base +
					(GRANULE_SIZE * next_granule++));
				parent_table[i] =
					s2tte_create_table(child_pa, level);
...
void s2tt_walk_lock_unlock_tc1(void)
{
	 ...
	 * on the start level of the S2 translation is
	...
	s2tt_walk_lock_unlock((const struct s2tt_context *)&s2_ctx,
			      pa, end_level, &wi);
...
void s2tt_walk_lock_unlock_tc5(void)
{
	 ...
	 * TEST CASE 5:
	 *
	 * Test s2tt_walk_lock_unlock() with a null rtt_walk structure.
	 ***************************************************************/
...
#if 0
	/* @TODO: Double check that this test passes, as call on previous
	 * patchset, as shown below, was passing even though it doesn't make
	 * much sense (trying the test with concatenated tables perhaps?)
	 */
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	s2tt_walk_lock_unlock(g_tables[sl + 1U + 1U], sl + 1L, max_ipa_size(),
			     pa, sl - 1U, &wi);
	test_helpers_fail_if_no_assert_failed();
#endif
}
