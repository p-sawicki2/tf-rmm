...
COMPILER_ASSERT(offsetof(struct rmm_core_manifest, version) == 0U);
COMPILER_ASSERT(offsetof(struct rmm_core_manifest, plat_data) == 8U);
COMPILER_ASSERT(offsetof(struct rmm_core_manifest, plat_dram) == 16U);
