 ...
 *	- token_hunk_len:	Pointer where the size of the retrieved
 *				platform token hunk will be stored.
 ...
 *				after returning. If hash_size is 0, the buffer
 *				will contain the part of the token that follows
 *				the part retrieved in the previous call.
