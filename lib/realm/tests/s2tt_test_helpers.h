...
/* Absolute RIPAS VALUES as per s2tt_private_defs.h */
...
/*
 * Attributes for a NS non-LPA2 TTE, excluding the ones setup by the host
 *
 * - NS
 * - XN
 * - AF
...
/*
 * Attributes mask for a NS non-LPA2 TTE, excluding the ones setup by the host
 *
 * - NS
 * - XN
 * - AF
...
/* Get the S2TTE PA mask for a given level */
