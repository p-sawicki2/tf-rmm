...
ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_tc2)
{
	s2tte_create_assigned_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_tc3)
{
	s2tte_create_assigned_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_tc4)
{
	s2tte_create_assigned_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_tc5)
{
	s2tte_create_assigned_tc5();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_tc6)
{
	s2tte_create_assigned_tc6();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_tc7)
{
