...
ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_emtpy_tc2)
{
	s2tte_create_assigned_empty_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_emtpy_tc3)
{
	s2tte_create_assigned_empty_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_create_assigned_emtpy_tc4)
{
...
TEST(s2tt_non_lpa2, s2tte_pa_table_tc1)
{
	s2tte_pa_table_tc1();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_pa_table_tc2)
{
	s2tte_pa_table_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_pa_table_tc3)
{
	s2tte_pa_table_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_pa_table_tc4)
{
	s2tte_pa_table_tc4();
}

ASSERT_TEST(s2tt_non_lpa2, s2tte_pa_table_tc5)
{
	s2tte_pa_table_tc5();
}
