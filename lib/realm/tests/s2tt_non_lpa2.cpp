...
TEST(s2tt_non_lpa2, s2tt_is_addr_lvl_aligned_tc1)
{
	s2tt_is_addr_lvl_aligned_tc1();
}

TEST(s2tt_non_lpa2, s2tt_is_addr_lvl_aligned_tc2)
{
	s2tt_is_addr_lvl_aligned_tc2();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_is_addr_lvl_aligned_tc3)
{
	s2tt_is_addr_lvl_aligned_tc3();
}

ASSERT_TEST(s2tt_non_lpa2, s2tt_is_addr_lvl_aligned_tc4)
{
	s2tt_is_addr_lvl_aligned_tc4();
}
