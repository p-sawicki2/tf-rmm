...
void s2tte_create_unassigned_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * Create an unassigned S2TTE for each valid RIPAS and verify
	 * that the S2TTE is valid.
	 ***************************************************************/
	...
	for (unsigned int i = 0U; i < ARRAY_SIZE(ripas); i++) {
		unsigned long expected_tte =
			S2TTE_INVALID_HIPAS_UNASSIGNED | ripas[i];
		unsigned long tte = s2tte_create_unassigned(ripas[i]);

		UNSIGNED_LONGS_EQUAL(expected_tte, tte);
	}
}

void s2tte_create_assigned_tc1(void)
{
	/***************************************************************
	 * TEST CASE 1:
	 *
	 * Create an assigned S2TTE with valid parameters and a valid
	 * RIPAS value and verify that the S2TTE is valid.
	 ***************************************************************/
	...
	for (long i = s2tt_test_helpers_min_block_lvl();
		...
		for (unsigned int j = 0U; j < ARRAY_SIZE(ripas); j++) {
			...
			unsigned long tte = s2tte_create_assigned(pa, i,
								  ripas[j]);
...
void s2tte_create_assigned_tc2(void)
{
	/***************************************************************
	 * TEST CASE 2:
	 *
	...
	(void)s2tte_create_assigned(pa, level, S2TTE_INVALID_RIPAS_EMPTY);
	test_helpers_fail_if_no_assert_failed();
}

void s2tte_create_assigned_tc3(void)
{
	/***************************************************************
	 * TEST CASE 3:
	 *
	...
	test_helpers_expect_assert_fail(true);
	(void)s2tte_create_assigned(pa, level, S2TTE_INVALID_RIPAS_DESTROYED);
	test_helpers_fail_if_no_assert_failed();
}


void s2tte_create_assigned_tc4(void)
{
	/***************************************************************
	 * TEST CASE 4:
	 *
...
void s2tte_create_assigned_tc5(void)
{
	/***************************************************************
	 * TEST CASE 5:
	 *
...
void s2tte_create_assigned_tc6(void)
{
	/***************************************************************
	 * TEST CASE 6:
	 *
...
void s2tte_create_assigned_tc7(void)
{
	/***************************************************************
	 * TEST CASE 7:
	 *
...
void s2tte_get_ripas_tc1(void)
{
	...
	for (unsigned int i = 0U; i < ARRAY_SIZE(ripas); i++) {
		/* HIPAS = UNASSIGNED */
		tte = s2tte_create_unassigned(ripas[i]);
		UNSIGNED_LONGS_EQUAL((unsigned int)s2tte_get_ripas(tte),
		...
		for (long level = s2tt_test_helpers_min_block_lvl();
			...
			if (ripas[i] != S2TTE_INVALID_RIPAS_RAM) {
				...
				tte = test_create_assigned(pa, level, ripas[i]);
				UNSIGNED_LONGS_EQUAL(
					(unsigned int)s2tte_get_ripas(tte),
					EXTRACT(S2TTE_INVALID_RIPAS, ripas[i]));
			}
		}
	}
...
void rtt_walk_lock_unlock_tc1(void)
{
	 ...
	 */
	rtt_walk_lock_unlock(g_tables[sl + 2UL], sl + 1L,
			     max_ipa_size(), pa, end_level, &wi);
	 ...
	 * starting on the next starting level.
	 */
	rtt_walk_lock_unlock(g_tables[sl + 2L], sl + 1L, max_ipa_size(),
			     pa, end_level, &wi);
	 ...
	 * starting on the next starting level.
	 */
	rtt_walk_lock_unlock(g_tables[sl + 2U], sl + 1L, max_ipa_size(),
			     pa, end_level, &wi);
...
void rtt_walk_lock_unlock_tc6(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	rtt_walk_lock_unlock(g_tables[sl + 1U], sl - 1L, max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void rtt_walk_lock_unlock_tc7(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	rtt_walk_lock_unlock(g_tables[sl + 1U], end_level + 1L, max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void rtt_walk_lock_unlock_tc8(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	rtt_walk_lock_unlock(g_tables[sl + 1U + 1U], sl + 1L, max_ipa_size(),
			     pa, sl - 1U, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void rtt_walk_lock_unlock_tc11(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	rtt_walk_lock_unlock(g_tables[sl + 1U], sl, (max_ipa_size() + 1UL),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
...
void rtt_walk_lock_unlock_tc12(void)
{
	...
	/* The call should cause an assertion failure */
	test_helpers_expect_assert_fail(true);
	rtt_walk_lock_unlock(g_tables[sl + 2U], sl + 2L, max_ipa_size(),
			     pa, end_level, &wi);
	test_helpers_fail_if_no_assert_failed();
}
