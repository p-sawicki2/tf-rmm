 ...
 */
bool inline s2tte_is_unassigned(unsigned long s2tte)
{
 ...
 */
bool inline s2tte_is_unassigned_empty(unsigned long s2tte)
{
 ...
 */
bool inline s2tte_is_unassigned_ram(unsigned long s2tte)
{
 ...
 */
bool inline s2tte_is_unassigned_ns(unsigned long s2tte)
{
	return (((s2tte & S2TTE_NS) != 0UL) &&
		  s2tte_has_hipas(s2tte, S2TTE_INVALID_HIPAS_UNASSIGNED));
}
 ...
 */
bool inline s2tte_is_unassigned_destroyed(unsigned long s2tte)
{
 ...
 */
bool inline s2tte_is_assigned_destroyed(unsigned long s2tte, long level)
{
	(void)level;
 ...
 */
bool inline s2tte_is_assigned_ram(unsigned long s2tte, long level)
{
 ...
 */
bool inline s2tte_is_assigned_ns(unsigned long s2tte, long level)
{
 ...
 */
bool inline s2tte_is_table(unsigned long s2tte, long level)
{
