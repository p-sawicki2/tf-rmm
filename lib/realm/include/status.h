...
/*
 * Typedef for status codes which can be returned from RMM commands.
 * Refer to smc-rmi.h for error codes and its meaning.
 */
...
{
	assert((status_t)(-1 * (long)ptr) < RMI_ERROR_COUNT);
