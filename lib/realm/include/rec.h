...
#define SHRINKABLE_COMPOSITE_TYPE	struct
#else /* CBMC */
 ...
 * structure.
 */
#define SHRINKABLE_COMPOSITE_TYPE	union
#endif /* CBMC */
 ...
 */
SHRINKABLE_COMPOSITE_TYPE sysreg_state {
 ...
 */
SHRINKABLE_COMPOSITE_TYPE common_sysreg_state {
 ...
 */
struct ns_state {
	SHRINKABLE_COMPOSITE_TYPE sysreg_state sysregs;
	unsigned long sp_el0;
...
struct rec {
	...
	SHRINKABLE_COMPOSITE_TYPE sysreg_state sysregs;
	SHRINKABLE_COMPOSITE_TYPE common_sysreg_state common_sysregs;
