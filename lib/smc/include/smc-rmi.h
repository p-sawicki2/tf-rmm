 ...
 * if ret0 == RMI_SUCCESS, otherwise, undefined.
 */
#define SMC_RMM_RTT_AUX_UNMAP_PROTECTED		SMC64_RMI_FID(U(0x33))
...
struct rmi_rec_exit {
	...
	SET_MEMBER_RMI(struct {
			...
			/* Base PA of MMIO region if RIPAS is pending due to RSI_RDEV_VALIDATE_IO */
