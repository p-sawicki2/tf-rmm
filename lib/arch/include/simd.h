 ...
 */
ASSERT_FIELD_OFFSET(struct fpu_regs, q, FPU_REGS_OFFSET_Q);
ASSERT_FIELD_OFFSET(struct sve_regs, z, SVE_REGS_OFFSET_Z);
ASSERT_FIELD_OFFSET(struct sve_regs, p, SVE_REGS_OFFSET_P);
ASSERT_FIELD_OFFSET(struct sve_regs, ffr, SVE_REGS_OFFSET_FFR);
