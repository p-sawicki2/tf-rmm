...
DEFINE_RENAME_SYSREG_RW_FUNCS(pmicntr_el0, PMICNTR_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(pmicfiltr_el0, PMICFILTR_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(pmsscr_el1, PMSSCR_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(pmuacr_el1, PMUACR_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(pmecr_el1, PMECR_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(pmiar_el1, PMIAR_EL1)
