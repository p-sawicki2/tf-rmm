...
#define ESR_EL2_ABORT_SAS_WIDTH		2U
...
#define ESR_EL2_ABORT_SRT_WIDTH		5U
...
#define ESR_EL2_SYSREG_MASK		SYSREG_ESR(3UL, 7UL, 15UL, 15UL, 7UL)

#define ESR_EL2_SYSREG_ID_MASK		SYSREG_ESR(3UL, 7UL, 15UL, 0UL, 0UL)
#define ESR_EL2_SYSREG_ID		SYSREG_ESR(3UL, 0UL, 0UL, 0UL, 0UL)

#define ESR_EL2_SYSREG_ID_AA64PFR0_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 4UL, 0UL)
#define ESR_EL2_SYSREG_ID_AA64PFR1_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 4UL, 1UL)
#define ESR_EL2_SYSREG_ID_AA64ZFR0_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 4UL, 4UL)

#define ESR_EL2_SYSREG_ID_AA64DFR0_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 5UL, 0UL)
#define ESR_EL2_SYSREG_ID_AA64DFR1_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 5UL, 1UL)

#define ESR_EL2_SYSREG_ID_AA64AFR0_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 5UL, 4UL)
#define ESR_EL2_SYSREG_ID_AA64AFR1_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 5UL, 5UL)

#define ESR_EL2_SYSREG_ID_AA64ISAR0_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 6UL, 0UL)
#define ESR_EL2_SYSREG_ID_AA64ISAR1_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 6UL, 1UL)

#define ESR_EL2_SYSREG_ID_AA64MMFR0_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 7UL, 0UL)
#define ESR_EL2_SYSREG_ID_AA64MMFR1_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 7UL, 1UL)
#define ESR_EL2_SYSREG_ID_AA64MMFR2_EL1	SYSREG_ESR(3UL, 0UL, 0UL, 7UL, 2UL)
...
#define ESR_EL2_SYSREG_TIMERS_MASK		SYSREG_ESR(3UL, 3UL, 15UL, 12UL, 0UL)
#define ESR_EL2_SYSREG_TIMERS			SYSREG_ESR(3UL, 3UL, 14UL, 0UL, 0UL)

#define ESR_EL2_SYSREG_TIMER_CNTP_TVAL_EL0	SYSREG_ESR(3UL, 3UL, 14UL, 2UL, 0UL)
#define ESR_EL2_SYSREG_TIMER_CNTP_CTL_EL0	SYSREG_ESR(3UL, 3UL, 14UL, 2UL, 1UL)
#define ESR_EL2_SYSREG_TIMER_CNTP_CVAL_EL0	SYSREG_ESR(3UL, 3UL, 14UL, 2UL, 2UL)
#define ESR_EL2_SYSREG_TIMER_CNTV_TVAL_EL0	SYSREG_ESR(3UL, 3UL, 14UL, 3UL, 0UL)
#define ESR_EL2_SYSREG_TIMER_CNTV_CTL_EL0	SYSREG_ESR(3UL, 3UL, 14UL, 3UL, 1UL)
#define ESR_EL2_SYSREG_TIMER_CNTV_CVAL_EL0	SYSREG_ESR(3UL, 3UL, 14UL, 3UL, 2UL)

#define ESR_EL2_SYSREG_ICC_PMR_EL1		SYSREG_ESR(3UL, 0UL, 4UL, 6UL, 0UL)

/*
 * GIC system registers encoding mask for registers from
 * ICC_IAR0_EL1(3, 0, 12, 8, 0) to ICC_IGRPEN1_EL1(3, 0, 12, 12, 7).
 */
#define ESR_EL2_SYSREG_ICC_EL1_MASK		SYSREG_ESR(3UL, 3UL, 15UL, 8UL, 0UL)
#define ESR_EL2_SYSREG_ICC_EL1			SYSREG_ESR(3UL, 0UL, 12UL, 8UL, 0UL)

#define ESR_EL2_SYSREG_ICC_DIR			SYSREG_ESR(3UL, 0UL, 12UL, 11UL, 1UL)
#define ESR_EL2_SYSREG_ICC_SGI1R_EL1		SYSREG_ESR(3UL, 0UL, 12UL, 11UL, 5UL)
#define ESR_EL2_SYSREG_ICC_SGI0R_EL1		SYSREG_ESR(3UL, 0UL, 12UL, 11UL, 7UL)
