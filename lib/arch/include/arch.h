...
#define PMICNTR_EL0		S3_3_C9_C4_0
#define PMICFILTR_EL0		S3_3_C9_C6_0
#define PMSSCR_EL1		S3_0_C9_C13_3
#define PMUACR_EL1		S3_0_C9_C14_4
#define PMECR_EL1		S3_0_C9_C14_5
#define PMIAR_EL1		S3_0_C9_C14_7

/* Hypervisor Debug Fine-Grained Read/Write Trap Registers 2 */
#define HDFGRTR2_EL2		S3_4_C3_C1_0
#define HDFGWTR2_EL2		S3_4_C3_C1_1

/* HDFGRTR2_EL2 and HDFGWTR2_EL2 Definitions */
#define HDFGRWTR2_EL2_nPMSSCR_EL1_BIT		(UL(1) << 7)
#define HDFGRWTR2_EL2_nPMSSDATA_BIT		(UL(1) << 6)
#define HDFGRWTR2_EL2_nPMUACR_EL1_BIT		(UL(1) << 4)
#define HDFGRWTR2_EL2_nPMICFILTR_EL0_BIT	(UL(1) << 3)
#define HDFGRWTR2_EL2_nPMICNTR_EL0_BIT		(UL(1) << 2)
#define HDFGRWTR2_EL2_nPMIAR_EL1_BIT		(UL(1) << 1)
#define HDFGRWTR2_EL2_nPMECR_EL1_BIT		(UL(1) << 0)

/* Access of the specified System registers are not trapped to EL2 */
#define	HDFGRWTR2_EL2_INIT	(HDFGRWTR2_EL2_nPMSSCR_EL1_BIT	  | \
				 HDFGRWTR2_EL2_nPMSSDATA_BIT	  | \
				 HDFGRWTR2_EL2_nPMUACR_EL1_BIT	  | \
				 HDFGRWTR2_EL2_nPMICFILTR_EL0_BIT | \
				 HDFGRWTR2_EL2_nPMICNTR_EL0_BIT	  | \
				 HDFGRWTR2_EL2_nPMIAR_EL1_BIT	  | \
				 HDFGRWTR2_EL2_nPMECR_EL1_BIT)
...
#define ID_AA64DFR0_EL1_PMU_NOT_SUPPORTED	UL(0)
#define ID_AA64DFR0_EL1_PMUv3			UL(1)
#define ID_AA64DFR0_EL1_PMUv3p1			UL(4)
#define ID_AA64DFR0_EL1_PMUv3p4			UL(5)
#define ID_AA64DFR0_EL1_PMUv3p5			UL(6)
...
/* PMCNTENCLR_EL0 Definitions */
#define PMCNTENCLR_EL0_CLEAR_ALL	0xFFFFFFFF

/* PMCNTENCLR_EL1 Definitions */
#define PMINTENCLR_EL1_CLEAR_ALL	0xFFFFFFFF

/* PMOVSCLR_EL0 Definitions */
#define PMOVSCLR_EL0_CLEAR_ALL		0xFFFFFFFF

/* PMCCFILTR_EL0 Definitions */
#define PMCCFILTR_EL0_P_BIT		(UL(1) << 31)
#define PMCCFILTR_EL0_U_BIT		(UL(1) << 30)
#define PMCCFILTR_EL0_NSK_BIT		(UL(1) << 29)
#define PMCCFILTR_EL0_NSU_BIT		(UL(1) << 28)
#define PMCCFILTR_EL0_NSH_BIT		(UL(1) << 27)
#define PMCCFILTR_EL0_M_BIT		(UL(1) << 26)
#define PMCCFILTR_EL0_SH_BIT		(UL(1) << 24)
#define PMCCFILTR_EL0_T_BIT		(UL(1) << 23)
#define PMCCFILTR_EL0_RLK_BIT		(UL(1) << 22)
#define PMCCFILTR_EL0_RLU_BIT		(UL(1) << 21)
#define PMCCFILTR_EL0_RLH_BIT		(UL(1) << 20)

#define PMCCFILTR_EL0_DISABLE_ALL	(PMCCFILTR_EL0_P_BIT | \
					PMCCFILTR_EL0_U_BIT  | \
					PMCCFILTR_EL0_T_BIT)
...
#define PMECR_EL1_SSE_KPME_BIT		(UL(1) << 2)

#define PMECR_EL1_PMEE_SHIFT		0
#define PMECR_EL1_PMEE_WIDHT		2

#define PMECR_EL1_DISABLE_ALL		INPLACE(PMECR_EL1_PMEE, 2UL)

/* PMICFILTR_EL0 Definitions */
#define PMICFILTR_EL0_SYNC_BIT		(UL(1) << 58)
#define PMICFILTR_EL0_P_BIT		(UL(1) << 31)
#define PMICFILTR_EL0_U_BIT		(UL(1) << 30)
#define PMICFILTR_EL0_NSK_BIT		(UL(1) << 29)
#define PMICFILTR_EL0_NSU_BIT		(UL(1) << 28)
#define PMICFILTR_EL0_NSH_BIT		(UL(1) << 27)
#define PMICFILTR_EL0_M_BIT		(UL(1) << 26)
#define PMICFILTR_EL0_SH_BIT		(UL(1) << 24)
#define PMICFILTR_EL0_T_BIT		(UL(1) << 23)
#define PMICFILTR_EL0_RLK_BIT		(UL(1) << 22)
#define PMICFILTR_EL0_RLU_BIT		(UL(1) << 21)
#define PMICFILTR_EL0_RLH_BIT		(UL(1) << 20)

#define PMICFILTR_EL0_DISABLE_ALL	(PMICFILTR_EL0_P_BIT | \
					PMICFILTR_EL0_U_BIT  | \
					PMICFILTR_EL0_T_BIT)
