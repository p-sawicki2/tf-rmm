...
#define TTBRx_EL2_BADDR_MSB_SHIFT	2
#define TTBRx_EL2_BADDR_MSB_WIDTH	U(4)
#define EL2_BADDR_MSB_SHIFT		48
#define EL2_BADDR_MSB_WIDTH		TTBRx_EL2_BADDR_MSB_WIDTH
