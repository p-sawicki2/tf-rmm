...
#define SVE_Z_REGS_SIZE(vq)	((vq) * (SVE_Z_REG_MIN_SIZE * SVE_Z_REG_NUM))
#define SVE_P_REGS_SIZE(vq)	((vq) * (SVE_P_REG_MIN_SIZE * SVE_P_REG_NUM))
#define SVE_FFR_REGS_SIZE(vq)	((vq) * (SVE_FFR_REG_MIN_SIZE * SVE_FFR_REG_NUM))
