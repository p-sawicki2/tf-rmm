...
TEST(simd, simd_init_TC2)
{
	...
	/* Verify that CPTR_EL2 not altered by init */
...
ASSERT_TEST(simd, simd_context_switch_TC3)
{
	 ...
	 * As lazy enablement is used, the (initially empty) Realm SIMD
	 * context is considered to be saved as part of initialisation.
	 * Therefore, a call to simd_context_switch() to save it again
	 * should cause an assertion to fail.
	 ******************************************************************/
