...
int attest_init_realm_attestation_key(void)
{
	...
	unsigned char cached_key[] = {
		...
		0xec, 0xfa, 0xb8, 0x58, 0x54, 0x8c, 0x63, 0x05, 0x7e, 0x16, 0xb0, 0xe6,
		0x76, 0x12, 0x0b, 0xbd, 0x0d, 0x2f, 0x9c, 0x29, 0xe0, 0x56, 0xc5, 0xd4,
		0x1a, 0x01, 0x30, 0xeb, 0x9c, 0x21, 0x51, 0x78, 0x99, 0xdc, 0x23, 0x14,
		0x6b, 0x28, 0xe1, 0xb0, 0x62, 0xbd, 0x3e, 0xa4, 0xb3, 0x15, 0xfd, 0x21,
		0x9f, 0x1c, 0xbb, 0x52, 0x8c, 0xb6, 0xe7, 0x4c, 0xa4, 0x9b, 0xe1, 0x67,
		0x73, 0x73, 0x4f, 0x61, 0xa1, 0xca, 0x61, 0x03, 0x1b, 0x2b, 0xbf, 0x3d,
		0x91, 0x8f, 0x2f, 0x94, 0xff, 0xc4, 0x22, 0x8e, 0x50, 0x91, 0x95, 0x44,
		0xae
	};
	unsigned int cached_key_len = 97;

	memcpy(realm_attest_public_key, cached_key, cached_key_len);
	realm_attest_public_key_len = cached_key_len;
#else
