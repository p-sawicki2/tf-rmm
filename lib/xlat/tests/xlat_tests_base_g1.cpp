...
void xlat_ctx_cfg_init_tc14(void)
{
	 ...
	 * TEST CASE 14:
	 *
	 * Try to initialize the xlat_ctx_cfg structure with the MMU enabled.
	 * Test for assert(is_mmu_enabled() == false).
	 *
	 ***************************************************************/
...
void xlat_ctx_init_tc5(void)
{
	 ...
	 * TEST CASE 5:
	 *
	 * Try to initialize a context with a null configuration and MMU enabled.
	 *
	 ***************************************************************/
	...
	(void)xlat_ctx_init(&ctx, NULL, &tbls, xlat_test_helpers_tbls(),
				XLAT_TESTS_MAX_TABLES);
	test_helpers_fail_if_no_assert_failed();
}
