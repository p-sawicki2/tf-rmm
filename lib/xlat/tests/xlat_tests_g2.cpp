 ...
 *	  lookup level is 'last_lvl'. This region will be descendant of
 *	  an entry at the end of a table of level 'fist_lvl'.
 *
 ...
 * granularity needed to map a block at level 'last_lvl'.
 *
				   ...
				   bool allow_transient)
{
	...
	*granularity = 1ULL << XLAT_ADDR_SHIFT(last_lvl);
	...
	for (unsigned i = 0U; i < 3U; i++) {
		 ...
		 * which there is a specific test). For simplicity,
