...
#define RMM_CPU_HANDLER_STACK_SIZE	PAGE_SIZE
...
#define RMM_CPU_HANDLER_STACK_END_VA	(CPU_STACK_VIRT - CPU_STACK_GAP)
#define CPU_HANDLER_STACK_VIRT		(RMM_CPU_HANDLER_STACK_END_VA - RMM_CPU_HANDLER_STACK_SIZE)
...
uintptr_t rmm_get_my_handler_stack(unsigned long cpuid);
