...
/*
 * Initializes the translation context (xlat_ctx) and the xlat_ctx_tbls if not
 * already initialized with the given xlat_ctx_cfg. The tables are created
 * according to the configuration in the provided xlat_mmap_region array.
