 ...
 * va_offset with regards to the context base address.
 *
...
/*
 * Function to unmap a physical memory page or block from the TTE and VA given.
 ...
 * Any umapped page or block will become transient.
 *
...
/*
 * Function to map a physical memory page or block from the TTE and VA given.
 ...
 * descriptors.
 *
 * This function can only be called on descriptors marked as TRANSIENT.
 *
