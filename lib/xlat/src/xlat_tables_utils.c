 ...
 * context.
 */
int xlat_unmap_memory_page(struct slot_tbl_info * const table,
			   const uintptr_t va)
{
	uint64_t *tte;
 ...
 * context.
 */
int xlat_map_memory_page_with_attrs(const struct slot_tbl_info * const table,
				    const uintptr_t va,
				    const uintptr_t pa,
 ...
 */
int xlat_get_table_from_va(struct slot_tbl_info * const retval,
			   const struct xlat_ctx * const ctx,
 ...
 */
uint64_t *xlat_get_tte(const struct slot_tbl_info * const entry,
				  const uintptr_t va)
{
	unsigned int index;
	uint64_t *table;
