...
ASSERT_TYPE_SIZE_EQUAL(struct measurement_desc_data, 0x100UL);

ASSERT_FIELD_OFFSET(struct measurement_desc_data, desc_type, 0x0U);
ASSERT_FIELD_OFFSET(struct measurement_desc_data, len, 0x8U);
ASSERT_FIELD_OFFSET(struct measurement_desc_data, rim, 0x10U);
ASSERT_FIELD_OFFSET(struct measurement_desc_data, ipa, 0x50U);
ASSERT_FIELD_OFFSET(struct measurement_desc_data, flags, 0x58U);
ASSERT_FIELD_OFFSET(struct measurement_desc_data, content, 0x60U);
...
ASSERT_TYPE_SIZE_EQUAL(struct measurement_desc_rec, 0x100UL);

ASSERT_FIELD_OFFSET(struct measurement_desc_rec, desc_type, 0x0U);
ASSERT_FIELD_OFFSET(struct measurement_desc_rec, len, 0x8U);
ASSERT_FIELD_OFFSET(struct measurement_desc_rec, rim, 0x10U);
ASSERT_FIELD_OFFSET(struct measurement_desc_rec, content, 0x50U);
...
ASSERT_TYPE_SIZE_EQUAL(struct measurement_desc_ripas, 0x100UL);

ASSERT_FIELD_OFFSET(struct measurement_desc_ripas, desc_type, 0x0U);
ASSERT_FIELD_OFFSET(struct measurement_desc_ripas, len, 0x8U);
ASSERT_FIELD_OFFSET(struct measurement_desc_ripas, rim, 0x10U);
ASSERT_FIELD_OFFSET(struct measurement_desc_ripas, base, 0x50U);
ASSERT_FIELD_OFFSET(struct measurement_desc_ripas, top, 0x58U);
